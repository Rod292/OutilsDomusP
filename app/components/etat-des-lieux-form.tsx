  ...
  return (
    <div className="container mx-auto pb-safe main-content">
      <div className="flex flex-col gap-6 p-2 sm:p-4">
        ...
        <div className="flex overflow-x-auto py-2 gap-2 sm:gap-3 no-scrollbar">
          {tabs.map((tab, index) => (
            <button
              key={index}
              onClick={() => setActiveTab(index)}
              className={`flex flex-col items-center justify-center min-w-16 sm:min-w-24 px-2 py-3 rounded-lg text-sm transition-all duration-200
                ${activeTab === index 
            ...
            >
              <div className="text-center">
                ...
                <div className="mt-1 text-sm">{tab.title}</div>
              </div>
            </button>
          ))}
        </div>
