  ...
  return (
    <div className="container mx-auto pb-safe main-content">
      <div className="flex flex-col gap-6 p-3 sm:p-5">
        ...
        <div className="flex overflow-x-auto py-3 gap-2 sm:gap-3 no-scrollbar bg-white rounded-xl shadow-sm p-2 border border-gray-100">
          {tabs.map((tab, index) => (
            <button
              key={index}
              onClick={() => setActiveTab(index)}
              className={`flex flex-col items-center justify-center min-w-20 sm:min-w-28 px-3 py-3 rounded-lg text-sm transition-all duration-200
                ${activeTab === index 
                  ? 'bg-[#DC0032] text-white font-medium shadow-md transform scale-[1.02]' 
            ...
            >
              ...
              <span className="text-xs sm:text-sm whitespace-nowrap mt-2 font-medium">{tab.title}</span>
            </button>
          ))}
        </div>
        ...
        >
          ...
          {activeTab === 0 && (
            <div className="bg-white p-6 rounded-xl shadow-sm space-y-6 border border-gray-100">
              <h2 className="text-xl font-semibold text-gray-900 mb-5 pb-2 border-b border-gray-100">Type d'état des lieux</h2>
              
              <div className="space-y-5">
                <div className="space-y-3">
                  <Label htmlFor="typeEtatDesLieux" className="text-base font-medium cursor-pointer font-medium text-gray-800 text-gray-800">
                    Type d'état des lieux
                  </Label>
                  <RadioGroup
                  ...
                  >
                    <div className="flex items-center space-x-3 bg-gray-50 px-4 py-3 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors">
                      <RadioGroupItem value="entree" id="entree" className="text-[#DC0032]" className="text-[#DC0032]" />
                      <Label htmlFor="entree" className="text-base font-medium cursor-pointer font-medium text-gray-800 cursor-pointer">
                        Entrée
                      </Label>
                    </div>
                    <div className="flex items-center space-x-3 bg-gray-50 px-4 py-3 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors">
                      <RadioGroupItem value="sortie" id="sortie" className="text-[#DC0032]" />
                      <Label htmlFor="sortie" className="text-base font-medium cursor-pointer font-medium text-gray-800 cursor-pointer">
                        Sortie
                      </Label>
                    </div>
                  </RadioGroup>
                ...
                <div className="space-y-3 pt-2">
                  <Label htmlFor="dateEtatDesLieux" className="text-base font-medium cursor-pointer font-medium text-gray-800 text-gray-800">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateFormField("dateEtatDesLieux", e.target.value)}
                    className="w-full sm:w-auto px-4 py-2.5 rounded-lg border border-gray-300 focus:border-[#DC0032] focus:ring-[#DC0032]"
                  />
                </div>
              </div>
            </div>
          ...
          {activeTab === 1 && (
            <div className="bg-white p-6 rounded-xl shadow-sm space-y-6 border border-gray-100">
              <h2 className="text-xl font-semibold text-gray-900 mb-5 pb-2 border-b border-gray-100">Informations sur le bien</h2>
          ...
          {activeTab === 2 && (
            <div className="bg-white p-6 rounded-xl shadow-sm space-y-6 border border-gray-100">
              <h2 className="text-xl font-semibold text-gray-900 mb-5 pb-2 border-b border-gray-100">Parties au contrat</h2>
          ...
          {activeTab === 3 && (
            <div className="bg-white p-6 rounded-xl shadow-sm space-y-6 border border-gray-100">
              <h2 className="text-xl font-semibold text-gray-900 mb-5 pb-2 border-b border-gray-100">Informations sur le contrat</h2>
          ...
          {activeTab === 4 && (
            <div className="bg-white p-6 rounded-xl shadow-sm space-y-6 border border-gray-100">
              <h2 className="text-xl font-semibold text-gray-900 mb-5 pb-2 border-b border-gray-100">Éléments remis</h2>
          ...
          {activeTab === 5 && (
            <div className="bg-white p-6 rounded-xl shadow-sm space-y-6 border border-gray-100">
              <h2 className="text-xl font-semibold text-gray-900 mb-5 pb-2 border-b border-gray-100">Relevés de compteurs</h2>
          ...
          {activeTab === 6 && (
            <div className="bg-white p-6 rounded-xl shadow-sm space-y-6 border border-gray-100">
              <h2 className="text-xl font-semibold text-gray-900 mb-5 pb-2 border-b border-gray-100">Pièces et équipements</h2>
