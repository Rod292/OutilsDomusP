            ...
            <div className="bg-white p-6 rounded-xl shadow-sm space-y-6 border border-gray-100">
              ...
              <div className="space-y-5">
                <div className="space-y-3">
                  <Label htmlFor="typeEtatDesLieux" className="text-base font-medium text-gray-800">
                    Type d'état des lieux
                  </Label>
                    <RadioGroup
                  ...
                  >
                    <div className="flex items-center space-x-3 bg-gray-50 px-4 py-3 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors">
                      <RadioGroupItem value="entree" id="entree" className="text-[#DC0032]" />
                      <Label htmlFor="entree" className="text-base font-medium cursor-pointer">
                        Entrée
                      </Label>
                      </div>
                    <div className="flex items-center space-x-3 bg-gray-50 px-4 py-3 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors">
                      <RadioGroupItem value="sortie" id="sortie" className="text-[#DC0032]" />
                      <Label htmlFor="sortie" className="text-base font-medium cursor-pointer">
                        Sortie
                      </Label>
                      </div>
                    </RadioGroup>
                ...
                <div className="space-y-3 pt-2">
                  <Label htmlFor="dateEtatDesLieux" className="text-base font-medium text-gray-800">
