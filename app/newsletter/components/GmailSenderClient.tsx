      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            ...
            <br /><br />
            L'envoi se fera automatiquement, avec une pause de {BATCH_DELAY/1000} seconde entre chaque lot pour éviter les timeouts.
            <br /><br />
          ...
          <Box sx={{ my: 2 }}>
            ...
            {microBatches.length > 0 && (
              <Alert severity="info" sx={{ mb: 2 }}>
                ...
                avec une pause de {BATCH_DELAY/1000} seconde entre chaque lot pour éviter les timeouts.
                <br />
